 ...
 *
 * 交替最小二乘 （alternating least squares）的简称
 * ALS 特指使用交替最小二乘求解的一个协同推荐算法。它通过观察到的所有用户给产品的打分，来推断每个用户的喜好并向用户推荐适合的产品。
 */
public final class JavaALS {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 4) {
            System.err.println("Usage: JavaALS <ratings_file> <rank> <iterations> <output_dir> [<blocks>]");
            System.exit(1);
        }
